...
#copy geckodriver
Invoke-WebRequest https://github.com/Microsoft/VSTS-DevOps-Labs/blob/selenium/selenium/arm%20template/geckodriver.exe?raw=true -OutFile "C:\Program Files\Mozilla Firefox\geckodriver.exe"
